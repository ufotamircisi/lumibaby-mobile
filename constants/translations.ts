...
const tr = {
  ...
  bizeUlasBaslik:        'Bize Ulaşın',
  bizeUlasEpostaAlt:     'Sorular, destek ve iş birlikleri için',
  bizeUlasTopluluk:      '🌑 Topluluğa Katıl',
  ...
  detGunlukBitti:         'Bugünlük dedektör hakkınız doldu 🌙 Yarın yenilenir.',
  analizDolduBaslik:      'Günlük Hakkınız Doldu',
  analizDolduAcik:        'Bugünlük analiz hakkınız doldu. Yarın yenilenir.',
  analizReklamKazan:      'Reklam izleyerek 1 analiz hakkı daha kazanabilirsiniz.',
...
const en = {
  ...
  bizeUlasBaslik:        'Contact Us',
  bizeUlasEpostaAlt:     'For questions, support and collaborations',
  bizeUlasTopluluk:      '🌑 Join the Community',
  ...
  detGunlukBitti:         'Daily detector limit reached 🌙 Resets tomorrow.',
  analizDolduBaslik:      'Daily Limit Reached',
  analizDolduAcik:        'Daily analysis limit reached. Resets tomorrow.',
  analizReklamKazan:      'Watch an ad to get 1 more analysis today.',
