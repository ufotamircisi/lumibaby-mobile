...
const tr = {
  ...
  bugunDetektor:          (n: number) => n > 0 ? `🎯 Bugün ${n} hakkınız var` : '🚫 Bugünlük limitinize ulaştınız',
  denemeDetektorSinirsiz: '',
  detSureDoldu:           'Süren Doldu',
  detReklamKazan:         'Reklam izleyerek 60 dakika daha kazanabilirsin.',
  detGunlukBitti:         'Bugünlük süren doldu.\nYarın tekrar gel 🌙',
  ...
  paywallUykuBaslik:      '😴 Uyku Dedektörü Hakkınız Bitti',
  paywallUykuAcik:        'Günlük uyku dedektörü hakkınızı kullandınız. Premium\'a geçin veya reklam izleyerek +1 hak kazanın.',
  // ── PAYWALL EKRANI ─────────────────────────────────────────────────────────
  ...
  pwAy:                   'ay',
  pwYil:                  'yıl',
  pwTasarruf:             '%40 Tasarruf',
  pwIleBasla:             (price: string) => `${price} ile Başla`,
  pwDenemeBtn:            '7 gün ücretsiz dene',
  pwUpgradeBtn:           'Premium\'a Geç',
  pwIptalEt:              'İstediğinde iptal et',
  pwHataYukleme:          'Planlar yüklenemedi. Lütfen tekrar deneyin.',
  pwHataInternet:         'Planlar yüklenemedi. İnternet bağlantınızı kontrol edin.',
  pwTekrarDene:           'Tekrar Dene',
  pwGeriYukle:            'Satın Alımları Geri Yükle',
  pwSatinAlindi:          'Teşekkürler!',
  pwSatinAlindiAcik:      'Premium üyeliğiniz aktif edildi.',
  pwHarika:               'Harika!',
  pwBasarili:             'Başarılı',
  pwGeriYuklendi:         'Satın alımlarınız geri yüklendi.',
  pwBulunamadi:           'Bulunamadı',
  pwBulunamadıAcik:       'Bu hesaba ait aktif bir satın alım bulunamadı.',
  pwGeriYuklemBas:        'Geri yükleme başarısız. Lütfen tekrar deneyin.',
  pwSatinAlmaBas:         'Satın alma işlemi başarısız. Lütfen tekrar deneyin.',
  pwYasal:                'Abonelik otomatik yenilenir. iTunes hesabınızdan ücret alınır. Yenileme döneminin en az 24 saat öncesinde iptal edilmediği sürece abonelik yenilenir.',
  // ── NİNNİLER ───────────────────────────────────────────────────────────────
...
const en = {
  ...
  bugunDetektor:          (n: number) => n > 0 ? `🎯 ${n} session${n !== 1 ? 's' : ''} left today` : '🚫 Daily limit reached',
  denemeDetektorSinirsiz: '',
  detSureDoldu:           "Time's Up",
  detReklamKazan:         'Watch an ad to earn 60 more minutes.',
  detGunlukBitti:         'Daily limit reached.\nCome back tomorrow 🌙',
  ...
  paywallUykuBaslik:      '😴 Sleep Detector Limit Reached',
  paywallUykuAcik:        'You\'ve used your daily sleep detector session. Go Premium or watch an ad for +1 session.',
  // ── PAYWALL SCREEN ─────────────────────────────────────────────────────────
  pwBaslik:               'LumiBaby Premium',
  ...
  pwYil:                  'yr',
  pwTasarruf:             '40% Off',
  pwIleBasla:             (price: string) => `Start with ${price}`,
  pwDenemeBtn:            'Try 7 days free',
  pwUpgradeBtn:           'Upgrade to Premium',
  pwIptalEt:              'Cancel anytime',
  pwHataYukleme:          'Plans could not be loaded. Please try again.',
  pwHataInternet:         'Plans could not be loaded. Please check your internet connection.',
  pwTekrarDene:           'Retry',
  pwGeriYukle:            'Restore Purchases',
  pwSatinAlindi:          'Thank you!',
  pwSatinAlindiAcik:      'Your Premium membership has been activated.',
  pwHarika:               'Great!',
  pwBasarili:             'Success',
  pwGeriYuklendi:         'Your purchases have been restored.',
  pwBulunamadi:           'Not Found',
  pwBulunamadıAcik:       'No active purchases found for this account.',
  pwGeriYuklemBas:        'Restore failed. Please try again.',
  pwSatinAlmaBas:         'Purchase failed. Please try again.',
  pwYasal:                'Subscription auto-renews. Charged to your iTunes account. Cancel at least 24 hours before the renewal date to avoid charges.',
  // ── LULLABIES ──────────────────────────────────────────────────────────────
